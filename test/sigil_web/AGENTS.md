...
- `app_layout_test.exs` — 7 tests for UI_AppLayout.
...
- `intel_market_live_test.exs` — 28 tests for `SigilWeb.IntelMarketLive`, covering browse filters, seller-authored report selection, manual sell flow, restricted listing flows, signed purchase/cancel flows, decrypt-after-purchase flows, inactive-listing errors, PubSub refresh, and acceptance journeys.
