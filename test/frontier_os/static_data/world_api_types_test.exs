defmodule FrontierOS.StaticData.WorldApiTypesTest.WorldApiPlug do
  @moduledoc false
...
defmodule FrontierOS.StaticData.WorldApiTypesTest do
  @moduledoc """
  ...
  alias FrontierOS.StaticData.WorldClient.HTTP, as: WorldClientHTTP
  alias FrontierOS.StaticData.WorldClientMock
  ...
  describe "SolarSystem.from_json/1" do
    test "SolarSystem.from_json/1 parses valid API response" do
      ...
      assert is_struct(solar_system, FrontierOS.StaticData.SolarSystem)
  ...
  describe "ItemType.from_json/1" do
    test "ItemType.from_json/1 parses valid API response" do
      ...
      assert is_struct(item_type, FrontierOS.StaticData.ItemType)
  ...
  describe "Constellation.from_json/1" do
    test "Constellation.from_json/1 parses metadata and discards embedded solarSystems" do
      ...
      assert is_struct(constellation, FrontierOS.StaticData.Constellation)
  ...
  describe "WorldClient behaviour and mock contract" do
    ...
    test "test environment uses WorldClientMock" do
      assert Application.fetch_env!(:frontier_os, :world_client) ==
               WorldClientMock
    end
  end
