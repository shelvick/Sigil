defmodule FrontierOSWeb.AppLayoutTest do
  @moduledoc """
  ...
  test "app layout shows FrontierOS branding" do
    html = render_layout(current_account: nil)

    assert html =~ ~r/>\s*FrontierOS\s*</
  end
  ...
  defp render_layout(assigns) do
    render_component(&FrontierOSWeb.Layouts.app/1,
