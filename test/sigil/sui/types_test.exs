defmodule Sigil.Sui.TypesTest do
  @moduledoc """
  ...
  test "parses TenantItemId with string-to-integer conversion" do
    ...
    assert is_struct(tenant_item_id, Sigil.Sui.Types.TenantItemId)
  ...
  test "parses Gate with nested structs and optional fields" do
    ...
    assert is_struct(gate, Sigil.Sui.Types.Gate)
  ...
  test "parses Assembly from JSON" do
    ...
    assert is_struct(assembly, Sigil.Sui.Types.Assembly)
  ...
  test "parses NetworkNode with nested Fuel and EnergySource" do
    ...
    assert is_struct(network_node, Sigil.Sui.Types.NetworkNode)
  ...
  test "parses Character with integer tribe_id" do
    ...
    assert is_struct(character, Sigil.Sui.Types.Character)
  ...
  test "parses present optional Metadata as nested struct" do
    ...
    assert is_struct(metadata, Sigil.Sui.Types.Metadata)
  ...
  test "parses GraphQL byte-vector and string scalar representations" do
    ...
    assert is_struct(location, Sigil.Sui.Types.Location)
