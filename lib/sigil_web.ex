defmodule SigilWeb do
  ...
  @doc """
  Defines router helpers for SigilWeb router.
  """
  @spec router() :: Macro.t()
  def router do
    quote do
  ...
  @doc """
  Defines LiveView helpers for SigilWeb LiveViews.
  """
  @spec live_view() :: Macro.t()
  def live_view do
    quote do
      use Phoenix.LiveView, layout: {SigilWeb.Layouts, :app}
  ...
  @doc """
  Defines LiveComponent helpers for SigilWeb LiveComponents.
  """
  ...
  @doc """
  Defines HTML component helpers for SigilWeb components.
  """
  @spec html() :: Macro.t()
  def html do
    quote do
