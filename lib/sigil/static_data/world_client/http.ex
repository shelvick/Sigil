defmodule Sigil.StaticData.WorldClient.HTTP do
  @moduledoc """
  ...
  defp retry_delay do
    Application.get_env(:sigil, :world_client_retry_delay, @default_retry_delay)
  end

  @spec max_retries() :: non_neg_integer()
  defp max_retries do
    Application.get_env(:sigil, :world_client_max_retries, @default_max_retries)
  end
