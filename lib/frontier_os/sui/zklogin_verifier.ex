defmodule FrontierOS.Sui.ZkLoginVerifier do
  @moduledoc """
  ...
  @challenge_prefix "Sign in to FrontierOS: "
  ...
  defp extract_raw_message(bytes) do
    case FrontierOS.Sui.BCS.decode_uleb128(bytes) do
  ...
  defp bcs_encode_bytes(bytes) do
    FrontierOS.Sui.BCS.encode_uleb128(byte_size(bytes)) <> bytes
  end
