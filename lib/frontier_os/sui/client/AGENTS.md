# lib/frontier_os/sui/client/

## Modules

- `FrontierOS.Sui.Client.HTTP` — Req-backed HTTP implementation of the `Sui.Client` behaviour
...
- `@behaviour FrontierOS.Sui.Client` — implements 3 callbacks
...
- Configurable retry: `Application.get_env(:frontier_os, :sui_client_retry_delay, 1_000)`
...
- `Req` — HTTP client
- `FrontierOS.Sui.Client` — behaviour contract (types, callbacks)
