defmodule FrontierOSWeb.CoreComponents do
  @moduledoc """
  Provides core UI components for FrontierOS.

  Contains the minimal set of components needed by the layout layer:
  flash messages, icons, and JS transition helpers. Additional
  components (forms, tables, etc.) will be added as features require them.
  """
  ...
  @doc """
  Renders flash notices for info and error, plus client/server disconnect messages.
  ...
  ## Examples
      ...
      <button phx-click={show("#modal")}>Show</button>
      <button phx-click={JS.push("hello") |> show("#modal")}>Show and push</button>
  """
  ...
  ## Examples
      ...
      <button phx-click={hide("#modal")}>Hide</button>
      <button phx-click={JS.push("bye") |> hide("#modal")}>Hide and push</button>
  """
